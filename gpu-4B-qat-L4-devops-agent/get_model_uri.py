def get_model_artifact_uri(project_id, publisher="google", model="gemma-4-E4B-it-qat-w4a16-ct"):
...
if __name__ == "__main__":
    ...
    get_model_artifact_uri(project_id, model="gemma-4@gemma-4-E4B-it-qat-w4a16-ct")
