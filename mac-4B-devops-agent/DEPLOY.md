...
## 📦 Model Artifacts
The model used is **Gemma 4 (E4B-it)**, served locally.

*   **Model ID:** `google/gemma-4-E4B-it`
*   **Local Image mapping:** `gemma4:e4b` (Ollama) or `google/gemma-4-E4B-it` (vLLM)
...
```bash
docker exec -t gemma4 ollama pull gemma4:e4b
```
