...
- **Default Cloud Run Service Name**: `gpu-12b-l4-devops-agent`
...
- **MCP Server entrypoint**: [server.py](file:///home/xbill/gemma4-tips/gpu-12B-L4-devops-agent/server.py)
- **Deployment Manifests & Logic**: Generated by `get_vllm_deployment_config` and `get_vllm_gpu_deployment_config` in [server.py](file:///home/xbill/gemma4-tips/gpu-12B-L4-devops-agent/server.py).
- **Test Suite**: [test_agent.py](file:///home/xbill/gemma4-tips/gpu-12B-L4-devops-agent/test_agent.py)
- **Standalone Grand Demo**: [demo_launcher.py](file:///home/xbill/gemma4-tips/gpu-12B-L4-devops-agent/demo_launcher.py)
