...
*   **Storage:** A GCS Bucket containing the Gemma model weights (e.g., `gs://PROJECT_ID-bucket/gemma-4-26B-it/`).
...
*   `MODEL_NAME`: The model identifier used by vLLM (defaults to `google/gemma-4-26B-it`).
