...
async def tokenize_prompt(url, token, prompt_text, model_name="/mnt/models/gemma-4-26B-A4B-it-qat-w4a16-ct"):
...
async def get_prompt_for_size(url, token, size, model_name="/mnt/models/gemma-4-26B-A4B-it-qat-w4a16-ct"):
    word = " hello"
